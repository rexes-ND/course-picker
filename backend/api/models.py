...
class Professor(models.Model):
    ...
    review_total_weigth=models.FloatField() #review total score of the professor
...
#     exam_day=models.IntegerField() #exam day: 0=Mon, 1=Tue, 2=Wen, 3=Thu, 4=Fri
#     exam_begin=models.IntegerField() #exam beginning time: 1230--> 12pm 30min 
#     exam_end=models.IntegerField() #exam end time--> 1000--> 10am 0min
...
class Lecture(models.Model):
    ...
    course_rev_tot=models.FloatField() #review total score of the lecture
...
class CPUser(models.Model):
    ...
    major_type=models.BooleanField() # true: Double major, false: Major/minor
    major=models.CharField(max_length=5) #CS: computer science, MAS: Mathematical, department_code
    minor=models.CharField(max_length=5) #CS: computer science, MAS: Mathematical/ if isDual=false and secondMajor=MAS, user has MAS as a submajor
